...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        private string _baseAddress = "https://cos730-product-manager.azurewebsites.net/Task";
        ...
        public async Task FullIntegrationTest()
        {
            ...
            await _clientHelper.EnsureListHasItems<TaskModel>(_baseAddress);

            // Get that item
            var existingItem = await _clientHelper.GetAndCheckItem<TaskModel>(_baseAddress, item.id);
            ...
            await _clientHelper.GetAndCheckItem<TaskModel>(_baseAddress, existingItem.id, false);
        ...
        private TaskModel GetNewItem(Guid guid)
        {
